...
<script type="text/javascript">
  ...
  <body>
    ...
    <div id="collection" align="center" style="width:80%;margin-left: 130px ">
		...
		<table class="timetable_sub">
			...
			<tr class="rem1">
				<td class="invert">
				<a href='/mall/find.do?bookId=${collectList.id }' target=_parent>${collectList.bookName}</a></td>
				...
				<td class="invert">	
					<h3 class="typ1 t-button">
						<a href="/mall/shoppingCart/addToShoppingCart.do?bookId=${collectList.id }&userId=${userId}&number=1" target=_parent> <span class="label label-warning" >加入购物车</span>
						</a>
					</h3>
				</td>
			</tr>
