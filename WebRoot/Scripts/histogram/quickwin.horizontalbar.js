...
horizontalbar.prototype.draw = function () { 
    ...
    this.ctx.stroke();
    //绘画x轴的箭头
    this.ctx.moveTo(50+width,this.ctx.canvas.clientHeight - 50);
    this.ctx.lineTo(50+width-5, this.ctx.canvas.clientHeight - 45);
    this.ctx.stroke();
    
    this.ctx.moveTo(50+width,this.ctx.canvas.clientHeight - 50);
    this.ctx.lineTo(50+width-5, this.ctx.canvas.clientHeight - 55);
    this.ctx.stroke();
