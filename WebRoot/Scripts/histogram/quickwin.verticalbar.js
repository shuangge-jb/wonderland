...
verticalbar.prototype.draw = function () {
    ...
    this.ctx.stroke();
    //绘画y轴的箭头
    this.ctx.moveTo(50, this.ctx.canvas.clientHeight - 50- height - 20);
    this.ctx.lineTo(45, this.ctx.canvas.clientHeight - 50 - height - 15);
    this.ctx.stroke();
    this.ctx.moveTo(50, this.ctx.canvas.clientHeight - 50- height - 20);
    this.ctx.lineTo(55, this.ctx.canvas.clientHeight - 50 - height - 15);
    this.ctx.stroke();
    //绘制刻度数
